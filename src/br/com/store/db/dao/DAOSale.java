...
public class DAOSale {
    ...
    public static void insert(Sale sale) throws SQLException, Exception {

        String sql = "INSERT INTO "
                + "sale (customer_id, seller_id, payment_terms_id, paid, discount, enabled, created_at) "
                + "VALUES (?,?,?,?,?,?,?)";
        ...
        try {
            ...
            stmt.setDate(7, new java.sql.Date(sale.getCreatedAt().getTime()));
