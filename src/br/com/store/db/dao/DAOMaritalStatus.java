...
public class DAOMaritalStatus {
    ...
    public static void update(MaritalStatus maritalStatus)
        ...
        String sql = "UPDATE maritalstatus SET description=?"
                + "WHERE (id=?)";
    ...
    //Search for a marital status by name
    public static List<MaritalStatus> search(String value) throws SQLException, Exception {

        String sql = "SELECT * FROM maritalstatus WHERE (UPPER(name) LIKE UPPER(?) AND enabled=?)";
